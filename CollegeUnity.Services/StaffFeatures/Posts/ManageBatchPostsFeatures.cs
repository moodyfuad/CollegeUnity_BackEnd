...
{
    public class ManageBatchPostsFeatures : ManagePost, IManageBatchPostsFeatures
    {
        public ManageBatchPostsFeatures(IRepositoryManager repositoryManager, IPostFilesFeatures postFilesFeatures) : base(postFilesFeatures, repositoryManager)
        {
        }
